...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=120, verbose_name='Takma isim')),
                ('name', models.CharField(max_length=60, verbose_name='Adı')),
                ('lastname', models.CharField(max_length=60, verbose_name='Soyadı')),
                ('email', models.EmailField(max_length=254, verbose_name='E-posta')),
                ('mobile', models.CharField(max_length=20, verbose_name='Cep Telefonu')),
                ('kayit', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ucret', models.IntegerField(verbose_name='Alıncan Ücret')),
                ('kayit', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'verbose_name': 'Kuş',
